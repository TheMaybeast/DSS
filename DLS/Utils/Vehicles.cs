        ...
        public static Dictionary<Model, DLSModel> GetAllModels()
        {
            ...
            foreach (string file in Directory.EnumerateFiles(path, "*.xml"))
            {
                try
                {
                    ...
                    {
                        dlsModel.WailSetupEnabled = true;
                        switch (dlsModel.SpecialModes.WailSetup.WailLightStage)
                        {
                            case "1":
                                dlsModel.WailLightStage = LightStage.One;
                                break;
                            case "2":
                                dlsModel.WailLightStage = LightStage.Two;
                                break;
                            case "3":
                                dlsModel.WailLightStage = LightStage.Three;
                                break;
                            case "4":
                                dlsModel.WailLightStage = LightStage.CustomOne;
                                break;
                            case "5":
                                dlsModel.WailLightStage = LightStage.CustomTwo;
                                break;
                        }
                        switch (dlsModel.SpecialModes.WailSetup.WailSirenTone)
                        {
                            case "1":
                                dlsModel.WailSirenStage = SirenStage.One;
                                break;
                            case "2":
                                dlsModel.WailSirenStage = SirenStage.Two;
                                break;
                            case "3":
                                dlsModel.WailSirenStage = SirenStage.Warning;
                                break;
                            case "4":
                                dlsModel.WailSirenStage = SirenStage.Warning2;
                                break;
                            case "5":
                                dlsModel.WailSirenStage = SirenStage.Horn;
                                break;
                        }
                    }

                    if (dlsModel.SpecialModes.PresetSirenOnLeaveVehicle != "" && dlsModel.SpecialModes.PresetSirenOnLeaveVehicle != "none")
                    {
                        switch (dlsModel.SpecialModes.PresetSirenOnLeaveVehicle)
                        {
                            case "stage1":
                                dlsModel.OOVLightStage = LightStage.One;
                                break;
                            case "stage2":
                                dlsModel.OOVLightStage = LightStage.Two;
                                break;
                            case "stage3":
                                dlsModel.OOVLightStage = LightStage.Three;
                                break;
                            case "custom1":
                                dlsModel.OOVLightStage = LightStage.CustomOne;
                                break;
                            case "custom2":
                                dlsModel.OOVLightStage = LightStage.CustomTwo;
                                break;
                        }
                    }
